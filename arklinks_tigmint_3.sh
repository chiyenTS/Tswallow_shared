#!/bin/bash
#
#SBATCH --job-name=arklinks_tigmint_3 # Job name
#SBATCH --nodes=1
#SBATCH --time=08:00:00
#SBATCH --ntasks=16 # Number of cores
#SBATCH --mem=60000 # Memory pool for all cores (see also --mem-per-cpu)
#SBATCH -o  /pylon5/mc5fs2p/chiyents/tsgenome/scripts/assembly/arklinks_tigmint_3-%j.o
#SBATCH -e /pylon5/mc5fs2p/chiyents/tsgenome/scripts/assembly/arklinks_tigmint_3-%j.e
...
draft="/pylon5/mc5fs2p/chiyents/tsgenome/data/tigarks/ark_out_3/supernova_hap1.tigmint.fa"
reads="/pylon5/mc5fs2p/chiyents/tsgenome/data/tigarks/ark_out_3/barcoded_reads.fq.gz"
...
cd /pylon5/mc5fs2p/chiyents/tsgenome/data/tigarks/ark_out_3
